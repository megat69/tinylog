...
- Added support for JSON output
  - There is no guarantee this JSON will be valid !
  - It is generated from strings in real time, and the library has no semantic information
  - For now, double quotes are escaped by getting turned into single quotes
